...
public class SomeIpMatrixCheckerApplication extends Application {
    @Override
    ...
    private void systemTrayActionListener(Stage stage, TrayIcon trayIcon, MenuItem aboutItem, MenuItem openItem, MenuItem exitItem) {
        ...
        aboutItem.addActionListener(e -> Platform.runLater(() -> {
            ...
            Image image = new Image(Objects.requireNonNull(this.getClass().getResourceAsStream("/projects/smIpCmxCheck/EPT_Logo.png")));
